...
!!! warning "Developer Notice"
    Vanguard is currently only avaliable on [Wally](https://wally.run/package/twrblxdevs/vanguard), A standalone version will be coming eventually as for now the source code can be found [Github](https://github.com/TwrblxDevs/vanguard)
!!! warning "Developer Notice"
